...
def get_shaders(shader_program_name):
    with open(f'UntexturedPathTracer/shaders/{shader_program_name}.vert') as file:
        vertex_shader = file.read()
    with open(f'UntexturedPathTracer/shaders/{shader_program_name}.frag') as file:
...
def calc_compute_shaders(shader_program_name):
    with open(f'UntexturedPathTracer/shaders/{shader_program_name}.comp.glsl') as file:
